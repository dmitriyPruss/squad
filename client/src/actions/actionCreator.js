...
export const changeShowAddChatToCatalog = (data) => ({
...
export const getEmailMessageRequest = () => ({
  type: ACTION.GET_EMAIL_MESSAGE_REQUEST,
});
...
export const getEmailMessageError = (error) => ({
  type: ACTION.GET_EMAIL_MESSAGE_ERROR,
  error,
});
...
export const directEmailBoxRequest = () => ({
  type: ACTION.DIRECT_EMAIL_BOX_REQUEST,
});

export const directEmailBoxSuccess = (data) => ({
  type: ACTION.DIRECT_EMAIL_BOX_SUCCESS,
  data,
});
