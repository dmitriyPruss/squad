const ACTION = {
  ...
  // CHECK NEW  OFFER (MODERATOR)
  CHECK_NEW_OFFER_ACTION: "CHECK_NEW_OFFER_ACTION",
  CHECK_NEW_OFFER_REQUEST: "CHECK_NEW_OFFER_REQUEST",
  CHECK_NEW_OFFER_SUCCESS: "CHECK_NEW_OFFER_SUCCESS",
  CHECK_NEW_OFFER_ERROR: "CHECK_NEW_OFFER_ERROR",

  // CHECK OFFER SENDMAIL (MODERATOR)
  CHECK_OFFER_SENDMAIL_ACTION: "CHECK_OFFER_SENDMAIL_ACTION",
  CHECK_OFFER_SENDMAIL_REQUEST: "CHECK_OFFER_SENDMAIL_REQUEST",
  CHECK_OFFER_SENDMAIL_SUCCESS: "CHECK_OFFER_SENDMAIL_SUCCESS",
  CHECK_OFFER_SENDMAIL_ERROR: "CHECK_OFFER_SENDMAIL_ERROR",

  // GET EMAIL MESSAGES
  GET_EMAIL_MESSAGE_ACTION: "GET_EMAIL_MESSAGE_ACTION",
  GET_EMAIL_MESSAGE_REQUEST: "GET_EMAIL_MESSAGE_REQUEST",
  GET_EMAIL_MESSAGE_SUCCESS: "GET_EMAIL_MESSAGE_SUCCESS",
  GET_EMAIL_MESSAGE_ERROR: "GET_EMAIL_MESSAGE_ERROR",

  // DIRECT TO EMAIL BOX
  DIRECT_EMAIL_BOX_ACTION: "DIRECT_EMAIL_BOX_ACTION",
  DIRECT_EMAIL_BOX_REQUEST: "DIRECT_EMAIL_BOX_REQUEST",
  DIRECT_EMAIL_BOX_SUCCESS: "DIRECT_EMAIL_BOX_SUCCESS",
  DIRECT_EMAIL_BOX_ERROR: "DIRECT_EMAIL_BOX_ERROR",

  // CHANGE_OFFER_STATUS_BY_MODERATOR
  CHANGE_OFFER_STATUS_BY_MODERATOR_ACTION: "CHANGE_OFFER_STATUS_BY_MODERATOR_ACTION",
  CHANGE_OFFER_STATUS_BY_MODERATOR_REQUEST: "CHANGE_OFFER_STATUS_BY_MODERATOR_REQUEST",
  CHANGE_OFFER_STATUS_BY_MODERATOR_SUCCESS: "CHANGE_OFFER_STATUS_BY_MODERATOR_SUCCESS",
  CHANGE_OFFER_STATUS_BY_MODERATOR_ERROR: "CHANGE_OFFER_STATUS_BY_MODERATOR_ERROR",
