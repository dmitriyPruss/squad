    ...
    <section className={styles.infoBlock}>
      <div className={styles.infoList}>
        <div className={styles.infoItem}>
          ...
          <p>
            For as low as $199, our naming contests and marketplace allow you to get an amazing
            brand quickly and affordably.
          </p>
        </div>
        <div className={styles.infoItem}>
          <div className={styles.arrow}>
          ...
          <p>
            Of course! We have policies in place to ensure that you are satisfied with your
            experience.
            <a href="#"> Learn More</a>
          </p>
        </div>
